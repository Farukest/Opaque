...
// Note: externalEuint64/externalEuint8 are ABI-encoded as bytes32 (FHE handles)
export const OPAQUE_MARKET_ABI = parseAbi([
  // ═══════ VIEW ═══════
...
export const MARKET_GROUP_ABI = parseAbi([
  // ═══════ VIEW ═══════
  "function question() view returns (string)",
...
export const ORACLE_RESOLVER_ABI = parseAbi([
  // ═══════ VIEW ═══════
  "function owner() view returns (address)",
...
export const CUSDT_ABI = parseAbi([
